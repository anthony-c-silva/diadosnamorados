document.addEventListener('DOMContentLoaded', function() {
  ...
  function sticker() {
   ...
   // Adiciona um evento de clique ao corpo do documento para iniciar a reprodução da música.
   document.body.addEventListener("click", function() {
    // Reproduz a música de fundo
    const music = document.getElementById('background-music');
    music.play().catch(error => console.error('Erro ao reproduzir música:', error));
    // Remove o evento de clique após a primeira interação do usuário.
